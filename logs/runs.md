...
| 004 | 0725 | main | **RAG 规则检索**: use_rag=true, top_k=5, budget=2000, gated slow update | deepseek-v4-flash | qwen-flash | val 0.6200→0.7300, test 0.6321→**0.7250**, final=best 零退化, 5 accept/32 reject/3 skip, 31M token | `outputs/searchqa_rag` | ✅🏆 四轮最佳：零退化+最高性价比，token 减半（vs #002），新建 rag_rule_selector.py |
