#!/usr/bin/env python3
"""Analyze the complete Phase 3F contract-control specificity grid."""
...
REPORT = ROOT / "paper/acl2027/results/phase3f_live_v2.md"
...
def report_text(result: dict[str, Any]) -> str:
    m = result["metrics"]
    return f"""# ACL 2027 Phase 3F contract-control live v2
