...
## Rules for Incomplete Questions
...
1. **Conciseness**: Is the answer the shortest unambiguous form? Prefer surnames over full names (e.g., 'Arthur' not 'Chester A. Arthur'), and avoid unnecessary articles or qualifiers.
