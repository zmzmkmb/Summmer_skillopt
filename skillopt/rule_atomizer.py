...
class AtomicRule:
    ...
    keywords: list[str]  # key terms for soft-match bonus (hit in query = small score boost)
    is_core: bool
    tags: list[str]
...
CORE_RULES: list[AtomicRule] = [
    AtomicRule("R01",
        ...
        trigger="answer from context documents", keywords=[],
    ...
    AtomicRule("R05",
        ...
        trigger="match all clues question", keywords=[],
    ...
    AtomicRule("R06",
        ...
        trigger="this country city person answer type", keywords=[],
    ...
    AtomicRule("R23",
        ...
        trigger="ellipsis ... dots blank fill underscore complete phrase", keywords=[],
    ...
    AtomicRule("R24",
        ...
        trigger="infer association consistent last resort fallback", keywords=[],
...
DYNAMIC_RULES: list[AtomicRule] = [
    ...
    AtomicRule("R07",
        ...
        trigger="distinctive phrase quote search locate find passage sentence subject answer appears directly stated in text",
        keywords=["phrase", "quote", "subject", "sentence", "passage"],
    ...
    AtomicRule("R08",
        ...
        trigger="document title heading summarize topic scan first sentence keyword match relevant passage",
        keywords=["title", "heading", "document", "scan", "keyword"],
    ...
    AtomicRule("R09",
        ...
        trigger="descriptive definition question opening introduction line paraphrase describes means is defined as",
        keywords=["definition", "define", "paraphrase", "describe", "means"],
    ...
    AtomicRule("R10",
        ...
        trigger="quotation marks direct quote exact search locate passage dialogue speech citation",
        keywords=['\"', '"', "quote", "quotation", "speech", "dialogue"],
    ...
    AtomicRule("R11",
        ...
        trigger="phrase appears multiple documents appeared twice repeated compare context primary main description subject of",
        keywords=["multiple", "primary", "context", "compare", "description"],
    ...
    AtomicRule("R12",
        ...
        trigger="authoritative source explicit definition list taxonomy catalog reference work encyclopedia over colloquial passing mention",
        keywords=["authoritative", "source", "encyclopedia", "reference", "taxonomy", "catalog"],
    ...
    AtomicRule("R13",
        ...
        trigger="documents conflict disagree contradict pick best satisfies all clues parts question not just keyword",
        keywords=["conflict", "disagree", "contradict", "satisfies", "clues"],
    ...
    AtomicRule("R14",
        ...
        trigger="person name surname family name given name first last full author writer poet painter artist composer singer actor actress character",
        keywords=["person", "name", "surname", "author", "writer", "poet", "painter", "artist", "composer", "singer", "actor", "actress", "character"],
        is_core=False, tags=["entity", "person_name"]),
    AtomicRule("R15",
        text="For vitamins: use a single letter (e.g., 'C' for vitamin C).",
        trigger="vitamin A B C D E K single letter nutrient supplement",
        keywords=["vitamin", "nutrient"],
        is_core=False, tags=["entity", "vitamin"]),
    AtomicRule("R16",
        text="For tribute bands: use the original band name, not the tribute band name.",
        trigger="tribute band cover band original band real band not tribute impersonator",
        keywords=["tribute", "band", "music", "cover"],
    ...
    AtomicRule("R17",
        ...
        trigger="company corporation business firm enterprise Inc Corp Ltd LLC limited Co incorporated legal suffix brand name",
        keywords=["company", "corporation", "business", "firm", "Inc", "Corp", "Ltd", "brand", "enterprise"],
    ...
    AtomicRule("R18",
        ...
        trigger="statement form clue asking for subject title of his her their its this that these author creator",
        keywords=["title", "author", "his", "her", "their", "drama", "novel", "book"],
    ...
    AtomicRule("R19",
        ...
        trigger="definition term being defined headword word means term refers to it can mean is a term for this term",
        keywords=["definition", "term", "means", "refers", "headword"],
    ...
    AtomicRule("R20",
        ...
        trigger="changed renamed modified altered replaced substituted original title name text wording from to instead of",
        keywords=["changed", "renamed", "modified", "altered", "original", "replaced"],
    ...
    AtomicRule("R21",
        ...
        trigger="Jeopardy trivia game show quiz Q and A question answer colon pipe delimiter flashcard format category",
        keywords=["Jeopardy", "trivia", "game", "quiz", "flashcard", "colon"],
    ...
    AtomicRule("R22",
        ...
        trigger="cities places towns Dijon Bordeaux southernmost northernmost island state capital hemisphere locations regions countries category",
        keywords=["city", "place", "town", "country", "region", "state", "capital", "island", "location", "hemisphere"],
