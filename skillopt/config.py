...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "evaluation.use_annealing": "use_annealing",
    "evaluation.annealing_T0": "annealing_T0",
    "evaluation.annealing_cooling_rate": "annealing_cooling_rate",
    "evaluation.annealing_T_min": "annealing_T_min",
    "env.name": "env",
